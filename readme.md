...
2 | Upload de atestados | Como aluno, quero cadastrar minhas informações pessoais e enviar atestados médicos, para a secretaria acessar e processar esses dados. | Um formulário que deve permitir o cadastro de informações pessoais e o envio de atestados médicos em PDF. | 13
...
Cadastro de equipes | Um formulário que deve permitir adicionar membros, definir suas funções e deve gerar automaticamente uma senha de acesso, que poderá ser personalizada. | Média | 2
